...
const THEMES = {
  deep_mine: { name: 'Deep Mine', W: 54, H: 40, wall: T.ROCK, floor: T.DIRT, mob: 'cave_bug', mobName: 'Cave Lurker', n: 14, boss: 'Rockjaw', bossDrop: 'rockjaw_pick', bossWeak: 'crush', ore: 'ore', chestLoot: 'iron_ore' },
  ruin_chapel: { name: 'Old Ruin Chapel', W: 46, H: 34, wall: T.WALL, floor: T.FLOOR, mob: 'cave_bug', mobName: 'Crypt Crawler', n: 12, boss: 'The Pale Priest', bossDrop: 'pale_veil', bossWeak: 'stab', ore: null, chestLoot: 'coins' },
  ...
  rival_camp: { name: 'Rival War Camp', W: 50, H: 38, wall: T.WALL, floor: T.DIRT, mob: 'bandit', mobName: 'Red-Ear Raider', n: 16, boss: 'Red-Ear Warlord', bossDrop: 'warlords_cleaver', bossWeak: 'ranged', ore: null, chestLoot: 'bronze_bar' },
};
...
export function generateInterior(id, opts = {}) {
  ...
  if (th.boss) { const s = randFloor(boss) || [boss.cx, boss.cy]; enemySpawns.push({ type: th.mob, x: s[0], y: s[1], name: th.boss, boss: true, bossDrop: th.bossDrop, bossWeak: th.bossWeak }); place({ x: boss.cx, y: boss.cy - 2, type: 'structure', color: 0xd0c040, label: `${th.boss}'s Hoard`, blocking: false, examine: 'The prize, if you can take it.', loot: th.chestLoot, wild: 'treasure' }); }
